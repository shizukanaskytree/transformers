...
# import debugpy; debugpy.listen(("0.0.0.0", 5678)); debugpy.wait_for_client(); debugpy.breakpoint()
...
model_config_before_grow = BertConfig(
    vocab_size=vocab_size,
    max_position_embeddings=max_length,
    num_hidden_layers=1,
)
print(f"model_config_before_grow: {model_config_before_grow}")
model = BertForMaskedLM(config=model_config_before_grow)
...
#     num_hidden_layers=2,
# )
# print(f"model_config_after_grow: {model_config_after_grow}")
# model_after_grow = BertForMaskedLM(config=model_config_after_grow)
...
trainer = Trainer(
    model=model,
    # model_before_grow=model_before_grow,
    # model_after_grow=model_after_grow,
    args=training_args,
